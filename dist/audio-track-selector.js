...
/***/ function(module, exports, __webpack_require__) {
	...
	for(var x=0;x < this.audiotrack.length;x++) {this.audiotrack[x].id = x;if(this.audiotrack[x]['default'] == true){this.updateCurrentLevel(this.audiotrack[x]);this.selectedLevelId = x;this.currentLevel = this.audiotrack[x];}}this.configureLevelsLabels(); //
	this.render();}},{key:'configureLevelsLabels',value:function configureLevelsLabels(){ //console.log(' Audio-Track configureLevelsLabels');
	...
	this.currentLevel = level?level:null;this.highlightCurrentLevel();}},{key:'highlightCurrentLevel',value:function highlightCurrentLevel(){ //console.log(' Audio-Track highlightCurrentLevel ('+this.currentLevel.id+')');
